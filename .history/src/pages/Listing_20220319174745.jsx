...
import { Link, useNavigate, useParams, navigator } from 'react-router-dom'
        ...
        <main>
...

            {
                shareLinkCopied && 
                    <p 
                        ...
                        onClick={() => {navigator.clipboard.writeText(this.state.textToCo)}}
                    >
                        Copy Link!
                    </p>
            }
            ...
            <div className="listingDetails">
                ...
                <ul className="listingDetailsList">
                    ...
                    <li>
                        {listing.parking === true ? 'Có bãi đậu xe' : 'Không có bãi đậu xe'}
                    </li>
                    <li>
                        {listing.furnished === true 
                            ? 'Nội thất có sẵn' : 'Nội thất trống'
                        }
                    </li>
                </ul>
