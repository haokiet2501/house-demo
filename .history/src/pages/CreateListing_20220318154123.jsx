    ...
    const onSubmit = async (e) => {
        ...
        if(geolocationEnabled) {
            const response = await fetch(
                `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=https://www.google.com/maps/place/Qu%C3%A1n+c%C6%A1m+t%E1%BA%A5m+l%E1%BB%99c+ph%C3%A1t/@10.8436844,106.6153154,17z/data=!3m1!4b1!4m5!3m4!1s0x31752b8e959cb21f:0x1738eff3690864b0!8m2!3d10.8437062!4d106.6175314?hl=vi-VN`
            )
        } else {
        ...
        <div className='profile'>
            ...
            <main>
                <form onSubmit={onSubmit}>
                    ...
                    <label className="formLabel">Giá</label>
