    ...
    const onSubmit = async (e) => {
        ...
        if(geolocationEnabled) {
            const response = await fetch(
                `https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyAPmuFQ2s1CogZ9jdLE_wNKRUuSLeJJ0G0`
            )
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div className="formPriceDiv">
                        <input 
                            ...
                            required
                        />
                        {type === 'rent' && 'sale' && <p className="formPriceText">$ / Tháng</p>}
                    </div>
                    {offer && (
                        <>
